  ...
  const [isFinished, setIsFinished] = useState(false);
        ...
        return (
            <div className="max-w-3xl mx-auto bg-white p-6 rounded shadow">
                ...
                <p className="text-gray-600 mb-4">
                    No flashcards available for this deck yet. Add some cards before practising.
                </p>
                <button
                    className="px-4 py-2 bg-indigo-600 text-white rounded"
    ...
    const renderSummary = () => (
        <div className="bg-white p-6 rounded-lg shadow-md mt-6">
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Practice Summary</h2>
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <p className="text-sm text-gray-500">Correct so far: {correctCount}</p>
                </div>
