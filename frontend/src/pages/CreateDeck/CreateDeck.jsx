...
const CreateDeck = ({
  ...
  const handleAddFlashcard = () => {
    ...
    const answerHtml = currentAnswer;
    if (!hasRichTextContent(questionHtml) || !hasRichTextContent(answerHtml)) {
    ...
    setFlashcards((prev) => [
      ...prev,
      { id: generateUniqueId(), question: questionHtml, answer: answerHtml },
    ]);
    setCurrentQuestion('');
    setCurrentAnswer('');
    setFlashcardError('');
